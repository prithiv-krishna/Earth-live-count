...
const $consomption = document.getElementById("consumption");
...
$climate.onclick=() =>{
    ...
    $consomption.style.backgroundColor="transparent"
    ...
    document.getElementById("frame").src="https://www.theworldcounts.com/embed/challenges/23?background_color=transparent&color=white&font_family=%22Helvetica+Neue%22%2C+Arial%2C+sans-serif&font_size=20"
       document.getElementById("save").innerHTML="1. Do your bit! Save trees, use renewable energy sources and prefer to travel green"
}
...
$consomption.onclick=() =>{
    ...
    $consomption.style.backgroundColor="#27AE60"
    $resources.style.backgroundColor="transparent"
    $people.style.backgroundColor="transparent"
    ...
    document.getElementById("save").innerHTML="2. Do your bit! Shop only what you need,eat only what you need and always save the left overs."
}
...
$resources.onclick=() =>{
    ...
    document.getElementById("save").innerHTML="3. Do your bit! Avoid all things plastic. Believe in Reduce, Reuse and Recycle"
}
...
$people.onclick=() =>{
    ...
    $consomption.style.backgroundColor=""
